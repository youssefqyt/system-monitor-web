  ...
  return (
    <div>
      <PageHeader
        ...
        description={
          accessMode === "browser"
            ? "Available only when the app is opened directly on the same machine"
            : "All listening ports on your machine"
        }
      ...
      {accessMode === "browser" && (
        <InfoBanner icon={Network} title="Browser privacy limit" tone="warning">
          A website cannot inspect the visitor&apos;s listening ports or local services. This page is only accurate on localhost, where the app can talk to the same machine it is monitoring.
        </InfoBanner>
      )}
